        ...
        <table class="table table-bordered table-responsive">
          ...
          ?>
            <tr>
              ...
              <td> <a href="<?= base_url() ?>index.php/admin/siswa/edit/<?= $DataSiswa['nisn'] ?>"><button type="button" class="btn btn-success">Edit</button></a> <a href="<?= base_url() ?>index.php/admin/siswa/delete/<?= $DataSiswa['nisn'] ?>"><button type="button" class="btn btn-danger">Delete</button</a></td>
          </tr>
...
<form  method="post"action=" <?php echo site_url('admin/siswa/tambah_aksi')  ?>" enctype="multipart/form-data"> 
